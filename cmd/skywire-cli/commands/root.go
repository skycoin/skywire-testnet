...
func init() {
	rootCmd.AddCommand(makeAppCmds())

	rootCmd.AddCommand(makeRouteFinderCmds())

	rootCmd.AddCommand(makeTransportDiscoveryCmds())

	rootCmd.AddCommand(makeMessagingDiscoveryCmds())

	rootCmd.AddCommand(makeTransportsCmds())

	rootCmd.AddCommand(makeRulesCmds())
}
