...
func (_m *MockServerRPCClient) Accept(lisID uint16) (uint16, routing.Addr, error) {
	ret := _m.Called(lisID)
	...
	var r1 routing.Addr
	if rf, ok := ret.Get(1).(func(uint16) routing.Addr); ok {
		r1 = rf(lisID)
	} else {
		r1 = ret.Get(1).(routing.Addr)
	}
...
func (_m *MockServerRPCClient) Dial(remote routing.Addr) (uint16, error) {
	ret := _m.Called(remote)

	var r0 uint16
	if rf, ok := ret.Get(0).(func(routing.Addr) uint16); ok {
		r0 = rf(remote)
	} else {
		r0 = ret.Get(0).(uint16)
	}
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(routing.Addr) error); ok {
		r1 = rf(remote)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *MockServerRPCClient) Listen(local routing.Addr) (uint16, error) {
	ret := _m.Called(local)
