...
func (sh setupHandlers) addRules() func(rules []routing.Rule) ([]routing.RouteID, error) {
	return func(rules []routing.Rule) ([]routing.RouteID, error) {
...
func (sh setupHandlers) deleteRules() func(rtIDs []routing.RouteID) ([]routing.RouteID, error) {
	return func(rtIDs []routing.RouteID) ([]routing.RouteID, error) {
...
func (sh setupHandlers) confirmLoop() func(ld setup.LoopData) ([]byte, error) {
	return func(ld setup.LoopData) ([]byte, error) {
...
func (sh setupHandlers) loopClosed() func(ld setup.LoopData) error {
	return func(ld setup.LoopData) error {
		lm := makeLoopMeta(sh.r.conf.PubKey, ld)
...
func (sh setupHandlers) reject() func(err error) error {
...
func (sh setupHandlers) respondWith() func(v interface{}, err error) error {
