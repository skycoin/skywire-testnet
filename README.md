...
**Install skywire-node, skywire-cli, manager-node and skyssh-cli**
...
- [The Real skyssh](/cmd/apps/skyssh-server) ([Client](/cmd/apps/skyssh-client))
...
$ GO111MODULE=on GOOS=linux go build -o /tmp/SKYNODE/apps/skyssh-server.v1.0  ./skyssh/cmd/server
$ GO111MODULE=on GOOS=linux go build -o /tmp/SKYNODE/apps/skyssh-client.v1.0  ./skyssh/cmd/client
...
# [2019-03-15T13:55:10Z] INFO [skywire]: Starting skyssh-server.v1.0
...
# [2019-03-15T13:55:10Z] INFO [router]: Got new App request with type Init: {"app-name":"skyssh-server",# "app-version":"1.0","protocol-version":"0.0.1"}
# [2019-03-15T13:55:10Z] INFO [router]: Handshaked new connection with the app skyssh-server.v1.0
