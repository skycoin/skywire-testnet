...
alias RUN_A='./visor ./integration/messaging/visorA.json --tag VisorA'
alias RUN_B='./visor ./integration/messaging/intermediary-visorB.json --tag VisorB'
alias RUN_C='./visor ./integration/messaging/visorC.json --tag VisorC'
