...
tmux send-keys -t NodeA -l "./skywire-networking-node ./integration/ssh/nodeA.json --tag NodeA $SYSLOG_OPTS"
tmux send-keys C-m
...
tmux send-keys -t NodeC -l "./skywire-networking-node ./integration/ssh/nodeC.json --tag NodeC $SYSLOG_OPTS"
tmux send-keys C-m
